...
class LiveDataService {
    ...
    async getReplayBoxScore(gameId) {
        try {
            ...
            const response = await axios_1.default.get(`${replayBaseUrl}/stats/json/boxscore/${gameId}`, {
    ...
    // Create a dynamic game that progresses over time
    createDynamicGame(originalGame) {
        const now = Date.now();
    ...
    async getLivePlayerStats(gameId) {
        try {
            const response = await axios_1.default.get(`${this.baseUrl}/stats/json/PlayerGameStats/${gameId}`, {
    ...
    async getPlayByPlay(gameId) {
        try {
            const response = await axios_1.default.get(`${this.baseUrl}/stats/json/PlayByPlay/${gameId}`, {
                params: { key: this.apiKey }
            });
            return response.data;
        }
    ...
    async getPlayerDetails(playerId) {
        try {
            const response = await axios_1.default.get(`${this.baseUrl}/scores/json/Player/${playerId}`, {
                params: { key: this.apiKey }
            });
            return response.data;
        }
    ...
    async getUpcomingGames() {
        try {
            const response = await axios_1.default.get(`${this.baseUrl}/scores/json/Games`, {
                params: { key: this.apiKey }
            });
            return response.data;
        }
